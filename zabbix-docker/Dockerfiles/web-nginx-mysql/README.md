...
These are the only official Zabbix web interface Docker images. They are based on Alpine Linux v3.22, Ubuntu 24.04 (noble), CentOS Stream 10 and Oracle Linux 10 images. The available versions of Zabbix web interface are:
    ...
    Zabbix web interface 7.2 (tags: alpine-7.2-latest, ubuntu-7.2-latest, ol-7.2-latest)
    Zabbix web interface 7.2.* (tags: alpine-7.2.*, ubuntu-7.2.*, ol-7.2.*)
    Zabbix web interface 7.4 (tags: alpine-7.4-latest, ubuntu-7.4-latest, ol-7.4-latest, alpine-latest, ubuntu-latest, ol-latest, latest)
    Zabbix web interface 7.4.* (tags: alpine-7.4.*, ubuntu-7.4.*, ol-7.4.*)
    Zabbix web interface 8.0 (tags: alpine-trunk, ubuntu-trunk, ol-trunk)
